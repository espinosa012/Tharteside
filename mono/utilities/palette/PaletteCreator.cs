...
public static class PaletteCreator
{
        ...
        string finalColor = "#000000", string middleColor = "#749140")
    {
        ...
        Array<string> paletteArray = GetGradientPaletteString(nColors, initialColor, finalColor, middleColor);
        // Creamos la imagen
        CreatePalettePng(paletteArray, filename);
    }


    private static Array<string> GetGradientPaletteString(int nColors = 48, string initialColor = "#FFFFFF", string finalColor = "#000000", string middleColor = "#749140")   // verde
    {
        // (el color intermedio determina el tono de la paleta)
        // Godot.Color paletteColor = new Godot.Color(0.8f, 0.4f, 0.4f); // Rojo claro
        Array<string> paletteArray = new Array<string>();
    ...
    private static void CreatePalettePng(Godot.Collections.Array<string> paletteArray, string filename="palette.png")
    {
    ...
    private static Godot.Color LerpColor(Godot.Color a, Godot.Color b, float t)
    {
    ...
    private static Godot.Color HexToColor(string hex)
    {   
        if (hex.StartsWith("#"))
        {
            hex = hex.Substring(1);
    ...
    private static string ColorToHex(Godot.Color color)
    {
